...
const resolvers = {
    Query: {
        getStudent: () => {
            return fetch(`https://student-service-808595275197.us-central1.run.app/students`).then(function (response) {
                if (response.ok) {
        ...
        getClassroom: () => {
            return fetch(`https://classroom-service-808595275197.us-central1.run.app/classrooms`).then(function (response) {
                if (response.ok) {
                    return response.json()
                } else {
                    return Promise.reject(response)
        ...
        getStudentById: (parent, args) => {
            ...
            return fetch(`https://student-service-808595275197.us-central1.run.app/student/${id}`).then(function (response) {
                if (response.ok) {
                    return response.json();
                } else {
                    return Promise.reject(response);
        ...
        getClassroomById: (parent, args) => {
            ...
            return fetch(`https://classroom-service-808595275197.us-central1.run.app/classroom/${id}`).then(function (response) {
                if (response.ok) {
                    return response.json();
                } else {
                    return Promise.reject(response);
        ...
        getClassroomByIds: (parent, args) => {
            ...
            return fetch(`https://classroom-service-808595275197.us-central1.run.app/classroom/find-by-ids`,
    ...
    Mutation: {
        createStudent: (parent, args) => {
            ...
            return fetch(`https://student-service-808595275197.us-central1.run.app/student`, {
        ...
        updateStudent: (parent, args) => {
            let id = args.id
            return fetch(`https://student-service-808595275197.us-central1.run.app/student/${id}`, {
        ...
        createClassroom: (parent, args) => {
            ...
            return fetch(`https://classroom-service-808595275197.us-central1.run.app/classroom`, {
        ...
        updateClassroom: (parent, args) => {
            let id = args.id
            return fetch(`https://classroom-service-808595275197.us-central1.run.app/classroom/${id}`, {
                method: 'PUT', body: JSON.stringify(args), headers: { 'Content-Type': 'application/json' }
            }).then(res => res.json())
        },
        ...
        deleteStudent: (parent, args) => {
            const { id } = args
            return fetch(`https://student-service-808595275197.us-central1.run.app/student/${id}`, { method: 'DELETE' }).then(res => res.json())
        },

        deleteClassroom: (parent, args) => {
            const { id } = args
            return fetch(`https://classroom-service-808595275197.us-central1.run.app/classroom/${id}`, { method: 'DELETE' }).then(res => res.json())
        },
...
const loaderStudent = {
    classrooms: new DataLoader(async ids => {
        ...
        const rows = await fetch(`https://classroom-service-808595275197.us-central1.run.app/classroom/find-by-ids`,
            { method: 'POST', body: JSON.stringify(dto), headers: { 'Content-Type': 'application/json' } }
        ).then(res => res.json())
console.log(rows);
